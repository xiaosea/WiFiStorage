...
public class FsNotification extends BroadcastReceiver {
    ...
    private void setupNotification(Context context) {
        Logger.d(TAG, "Setting up the notification");
        ...
        if (address == null) {
            Logger.w(TAG, "Unable to retreive the local ip address");
            return;
        }
        ...
        Logger.d(TAG, "Notication setup done");
    }

    private void clearNotification(Context context) {
        Logger.d(TAG, "Clearing the notifications");
        String ns = Context.NOTIFICATION_SERVICE;
        NotificationManager nm = (NotificationManager) context.getSystemService(ns);
        nm.cancelAll();
        Logger.d(TAG, "Cleared notification");
    }
}
