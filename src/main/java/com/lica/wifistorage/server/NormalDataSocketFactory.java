...
public class NormalDataSocketFactory extends DataSocketFactory {
    ...
    private void clearState() {
        ...
        remoteAddr = null;
        remotePort = 0;
        Logger.d(TAG, "NormalDataSocketFactory state cleared");
    }
    ...
    public int onPasv() {
        ...
        try {
            ...
            Logger.d(TAG, "Data socket pasv() listen successful");
            return server.getLocalPort();
        } catch (IOException e) {
            Logger.e(TAG, "Data socket creation error");
            clearState();
            return 0;
        }
    }
    ...
    public Socket onTransfer() {
        if (server == null) {
            ...
            if (remoteAddr == null || remotePort == 0) {
                Logger.i(TAG, "PORT mode but not initialized correctly");
                clearState();
                return null;
            }
            Socket socket;
            try {
                ...
                Logger.i(TAG, "Couldn't open PORT data socket to: " + remoteAddr.toString()
                        + ":" + remotePort);
                clearState();
                return null;
            }
            ...
            try {
                ...
                Logger.e(TAG, "Couldn't set SO_TIMEOUT");
                clearState();
                return null;
            }
            ...
            try {
                ...
                Logger.d(TAG, "onTransfer pasv accept successful");
            } catch (Exception e) {
                Logger.i(TAG, "Exception accepting PASV socket");
                socket = null;
            }
            clearState();
