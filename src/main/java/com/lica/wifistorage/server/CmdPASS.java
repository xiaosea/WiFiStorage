...
public class CmdPASS extends FtpCmd implements Runnable {
    ...
    public void run() {
        ...
        if (ctx == null) {
            ...
            Logger.e(TAG, "No global context in PASS\r\n");
        }
        String username = FsSettings.getUserName();
        String password = FsSettings.getPassWord();
        if (username == null || password == null) {
            Logger.e(TAG, "Username or password misconfigured");
            ...
            Logger.i(TAG, "User " + username + " password verified");
            ...
            Logger.i(TAG, "Failed authentication");
