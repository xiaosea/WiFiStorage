...
import com.lica.wifistorage.MediaUpdater;
...
abstract public class CmdAbstractStore extends FtpCmd {
    ...
    public void doStorOrAppe(String param, boolean append) {
        Logger.d(TAG, "STOR/APPE executing with append=" + append);
        ...
        // myLogger.l(Logger.DEBUG, "STOR original priority: " + origPriority);
        storing: {
            ...
            Logger.d(TAG, "Data socket ready");
            ...
            // myLogger.l(Logger.DEBUG, "Started DedicatedWriter");
            int numRead;
            // Thread.currentThread().setPriority(Thread.MIN_PRIORITY);
            // int newPriority = Thread.currentThread().getPriority();
            // myLogger.l(Logger.DEBUG, "New STOR prio: " + newPriority);
            if (sessionThread.isBinaryMode()) {
                Logger.d(TAG, "Mode is binary");
            } else {
                Logger.d(TAG, "Mode is ascii");
            }
            while (true) {
                /*
                ...
                case -1:
                    Logger.d(TAG, "Returned from final read");
                ...
                default:
                    try {
                        // Logger.d(TAG, "Enqueueing buffer of " + numRead);
                        ...
                        // Logger.d(TAG, "Closing and reopening file: " + storeFile);
                        // out.close();
                        ...
                        // Logger.d(TAG, "Flushing: " + storeFile);
                        // out.flush();
                        // bytesSinceFlush = 0;
                        // }
                        ...
                        Logger.d(TAG, "Exception while storing: " + e);
        ...
        if (errString != null) {
            Logger.i(TAG, "STOR error: " + errString.trim());
